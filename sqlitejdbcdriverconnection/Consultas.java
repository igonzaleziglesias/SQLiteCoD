...
public class Consultas extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
          ...
          int x= upd.update(Integer.parseInt(jTextField4.getText()), jTextField8.getText(), jTextField9.getText(), jTextField11.getText());
            System.out.println("modificaciones: "+x);
        } catch (Exception e) {
        }
        jTextField1.setText("");
        jTextField3.setText("");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            int x=app.insert(Integer.parseInt(jTextField3.getText()), jTextField7.getText(), jTextField6.getText(), jTextField10.getText());
            System.out.println("modificaciones: "+x);
        } catch (Exception e) {
        }
        jTextField1.setText("");
